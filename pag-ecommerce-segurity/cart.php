...
<body>
   ...
   <section class="products shopping-cart">
      ...
      <div class="box-container">
         ...
         ?>
               <form action="" method="post" class="box">
                  ...
                  <input type="submit" value="Eliminar artículo" onclick="return confirm('¿Eliminar del carrito?');" class="delete-btn" name="delete">
               </form>
         <?php
      ...
      <div class="cart-total">
         ...
         <a href="cart.php?delete_all" class="delete-btn <?= ($grand_total > 1) ? '' : 'disabled'; ?>" onclick="return confirm('¿Vaciar el carrito?');">Vaciar carrito</a>
